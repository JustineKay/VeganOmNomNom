...
static NSString * const kConsumerKey       = @"E55XCmJCbSrhJ-BtforP4w";
static NSString * const kConsumerSecret    = @"EJrszNNmY8-4t1diOu4FeRu6IyI";
static NSString * const kToken             = @"SV1k-ha9h09pTelPdD9iCtu-0iYp-PEB";
static NSString * const kTokenSecret       = @"cAGd1Lt0bVs7XbTay7X3vsAPCKU";
